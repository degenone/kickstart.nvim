...
--   end,
-- })
-- vim.api.nvim_set_keymap('i', '<C-c>', '<Cmd>lua Set_listchars(true)<CR><C-c>', { noremap = true })
...
require('lazy').setup({
  ...
  -- Alternatively I could do file specific settings with `autocmd` or `modeline`
  -- or setup files under `/nvim/after/ftplugin/javascript.vim`
  'github/copilot.vim',
  {
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      -- try this out, first impressions: not sure if I like it
